...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBtn1Clicked(View v){
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:01024580504"));
        startActivity(intent);
    }

    public void onBtn2Clicked(View v){
        Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:01024580504"));
        startActivity(intent);
    }

    public void onBtn3Clicked(View v){
        Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:01024580504"));
        startActivity(intent);
    }
